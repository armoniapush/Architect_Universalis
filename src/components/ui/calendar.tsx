  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_outside:
          "day-outside text-muted-foreground opacity-75 aria-selected:bg-accent/50 aria-selected:text-muted-foreground aria-selected:opacity-30", // updated opacity for day_outside
