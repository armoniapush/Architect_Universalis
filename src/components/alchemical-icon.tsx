...
export const AlchemicalIcon = ({ symbol, size = 24, className, ...props }: AlchemicalIconProps) => {
  ...
  switch (symbol) {
    ...
    case 'primaMateria': // Geography, Foundation
      return (
        <svg {...iconProps} aria-label="Prima Materia Symbol">
    ...
    case 'athanor': // History, Government, Long Processes
      return (
        <svg {...iconProps} aria-label="Athanor Symbol">
    ...
    case 'crucible': // Economy, Industry, Transformation
      return (
        <svg {...iconProps} aria-label="Crucible Symbol">
    ...
    case 'solveCoagula': // Politics, Diplomacy, Social Dynamics
      return (
        <svg {...iconProps} aria-label="Solve et Coagula Symbol">
          <path d="M8 8l4 4 4-4" />
    ...
    case 'regulus': // Military, Nobility, Power
      return (
        <svg {...iconProps} aria-label="Regulus Symbol">
    ...
    case 'quintessence': // Religion, Magic, Art, Core Essence
      return (
        <svg {...iconProps} aria-label="Quintessence Symbol">
    ...
    case 'scriptulum': // Languages, Documents, Literature
      return (
        <svg {...iconProps} aria-label="Scriptulum Symbol">
    ...
    case 'civitas': // Cities, Society Structure
      return (
        <svg {...iconProps} aria-label="Civitas Symbol">
     ...
     case 'hourglass': // History, Time
      return (
        <svg {...iconProps} aria-label="Hourglass Symbol">
    ...
    case 'scales': // Law, Justice, Balance
      return (
        <svg {...iconProps} aria-label="Scales Symbol">
    ...
    case 'atom': // Technology, Science, Magic Systems
      return (
        <svg {...iconProps} aria-label="Atom Symbol">
    ...
    case 'default':
      return (
        <svg {...iconProps} aria-label="Default Alchemical Symbol">
