...
export type AlchemicalSymbol = 
  ...
  'crossedSwords' | // Added new symbol
  'default';
...
export const AlchemicalIcon = ({ symbol, size = 24, className, ...props }: AlchemicalIconProps) => {
  ...
  switch (symbol) {
    ...
    case 'athanor': 
      return (
        <svg {...defaultColoredIconProps} aria-label="Athanor Symbol">
          <path d="M8 20V10L6 8V4h12v4l-2 2v10H8zm4-10h0" /> 
    ...
    case 'crossedSwords':
      return (
        <svg {...defaultColoredIconProps} aria-label="Crossed Swords Symbol">
          {/* Sword 1 (bottom-left to top-right) */}
          <line x1="6" y1="18" x2="18" y2="6" />
          {/* Guard for Sword 1 */}
          <line x1="4.5" y1="16.5" x2="7.5" y2="19.5" /> {/* Adjusted guard slightly for better perpendicular appearance */}

          {/* Sword 2 (top-left to bottom-right) */}
          <line x1="6" y1="6" x2="18" y2="18" />
          {/* Guard for Sword 2 */}
          <line x1="4.5" y1="7.5" x2="7.5" y2="4.5" /> {/* Adjusted guard slightly */}
        </svg>
      );
    default:
    case 'default':
